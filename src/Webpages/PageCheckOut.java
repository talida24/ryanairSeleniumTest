...
public class PageCheckOut {
    ...
    public void pay() throws InterruptedException {
        ...
        Thread.sleep(5000);
        js.executeScript("window.scrollTo(0, 870)");
        driver.findElement(By.xpath("<div _ngcontent-ryanair-payment-c22=\"\" class=\"payment-methods-error b3 ng-star-inserted\" ryalertcontent=\"\">Oops, something went wrong. Please check your payment details and try again</div>"));
