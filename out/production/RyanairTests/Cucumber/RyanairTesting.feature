...
#  Scenario Outline: Search return ticket for a specific date for 1 person
#    Given I make a booking from "<from>" to "<to>" on "<dateF>" "<monthF>" "<dateR>" "<monthR>" for <0> adults
...
#      |Toulouse|Malta |23       |Apr       |26       |Apr       |1           |0             |5555555555555555|456|09/21 |Talida Rosioru    |str. Victoriei|Costesti|Romania |115200   |

  Scenario Outline: Search return ticket for a specific date for 3 people
